      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring absolute top-4 right-4 rounded-md opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none"
          >
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "mt-auto flex flex-col gap-2 border-t px-6 pt-4 pb-6",
        className,
      )}
      {...props}
    />
